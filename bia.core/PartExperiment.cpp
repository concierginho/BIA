...
/// </summary>
BIA::PartExperiment::PartExperiment(fs::path path, std::string parentName, bool isHorizontal, fs::path common)
{
...
fs::path BIA::PartExperiment::GetResultsCommon() const
{
    return _common;
}
